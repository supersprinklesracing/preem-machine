...
import type { Contribution, Race } from '@/datastore/types';
import {
  Avatar,
  Box,
  Button,
...
const BigScreenPage: React.FC<{ params: { id: string } }> = ({ params }) => {
  const initialRace = raceSeries
    .flatMap((series) => series.races)
